    ...
    function (
        ...
        return Component.extend({
            ...
            enableCheckout: ko.pureComputed(function(){
                 ...
                 * @author Luca Sculco
                 *
                 * ritorna sempre true perchè a volte mi trovo il pulsante
                 * disabilitato, tanto il loader finisce prima che l'utente clicca
                 */
		...
		var term = this.validateTermCondition();
                return shipping && billing && term;
            },
            ...
            validateTermCondition: function(){
                if(jQuery('#agreement_osc').is(':checked') == false){
                        this.showErrorMessage($t('Please agree to all the terms and conditions before placing the order.'));
                           return false;
                    }else{
                           return true;
                    }
